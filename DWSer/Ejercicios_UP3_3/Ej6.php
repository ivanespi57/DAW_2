<?php
    ...
    $multiplicandoAnt = isset($_COOKIE["multiplicando"]) ? $_COOKIE["multiplicando"] : "Ninguno";
    $multiplicadorAnt = isset($_COOKIE["multiplicador"]) ? $_COOKIE["multiplicador"] : "Ninguno";

    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $multiplicando = $_POST["multiplicando"];
        $multiplicador = $_POST["multiplicador"];

        setcookie("multiplicando", $multiplicando, time() + 3600);
        setcookie("multiplicador", $multiplicador, time() + 3600);
