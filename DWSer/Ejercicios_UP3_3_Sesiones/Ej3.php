<?php
    ...
    $num1Anterior = isset($_SESSION["num1"]) ? $_SESSION["num1"] : "Ninguno";
    $num2Anterior = isset($_SESSION["num2"]) ? $_SESSION["num2"] : "Ninguno";
    $operacionAnterior = isset($_SESSION["operacion"]) ? $_SESSION["operacion"] : "Ninguna";
...
<html lang="es">
    ...
    <body>
        ...
        <h2>Ejercicio: Calculadora con Sesión</h2>
